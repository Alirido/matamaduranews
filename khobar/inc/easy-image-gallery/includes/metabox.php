...
function easy_image_gallery_add_meta_box() {
    ...
    //foreach ( $post_types as $post_type => $status ) {
        add_meta_box( 'easy_image_gallery', apply_filters( 'easy_image_gallery_meta_box_title', __( 'Galeri Foto', 'easy-image-gallery' ) ), 'easy_image_gallery_metabox', $post_types, apply_filters( 'easy_image_gallery_meta_box_context', 'normal' ), apply_filters( 'easy_image_gallery_meta_box_priority', 'low' ) );
    //}
...
?>
    ...
    <p class="add_gallery_images hide-if-no-js">
        <a href="#"><?php _e( 'Tambahkan Foto', 'easy-image-gallery' ); ?></a>
    </p>
...
?>
    ...
    <p>
        <label for="easy_image_gallery_link_images">
            <input type="checkbox" id="easy_image_gallery_link_images" value="on" name="easy_image_gallery_link_images"<?php echo $checked; ?> /> <?php _e( 'Link pada ukuran foto asli', 'easy-image-gallery' )?>
        </label>
    </p>
