...
function easy_image_gallery_scripts() {
	...
	// JS
	wp_register_script( 'pretty-photo', get_template_directory_uri().'/inc/easy-image-gallery/includes/lib/prettyphoto/jquery.prettyPhoto.js', array( 'jquery' ), '1.0.0', true );
	wp_register_script( 'fancybox', get_template_directory_uri().'/inc/easy-image-gallery/includes/lib/fancybox/jquery.fancybox-1.3.4.pack.js', array( 'jquery' ), '1.0.0', true );

	// CSS
	wp_register_style( 'pretty-photo', get_template_directory_uri().'/inc/easy-image-gallery/includes/lib/prettyphoto/prettyPhoto.css', '', '1.0.0', 'screen' );
	wp_register_style( 'fancybox', get_template_directory_uri().'/inc/easy-image-gallery/includes/lib/fancybox/jquery.fancybox-1.3.4.css', '', '1.0.0', 'screen' );


	wp_register_style( 'easy-image-gallery', get_template_directory_uri() . '/inc/easy-image-gallery/includes/css/easy-image-gallery.css', '', '1.0.0', 'screen' );
