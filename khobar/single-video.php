...
global $post;
$img_src = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'post-slider-large' );
...
<span href="#" style="background:#aaaaaa;width: 35px;padding: 8px 2px;border-radius: 100%;cursor:pointer;display: inline-table;" class="ac white rd2 mb10 f16 show" onClick="fbox('#shareother','Share','inline')" title="Share"><i class="fa fa-share-alt fa-lg"></i></span>	
	...
	<div id="article_con" class="fl pt20 pos_rel">
			<div id="artimg">
			<div class="pb20 ovh">
			<div class="ovh imgfull_div" style="height: auto!important;">
			<iframe id="td_youtube_player" width="100%" height="560" src="https://www.youtube.com/embed/<?php echo $youtube_url[0];?>?enablejsapi=1&amp;feature=oembed&amp;wmode=opaque&amp;vq=hd720" frameborder="0" allowfullscreen="" style="height: 417.6px;"></iframe>			
			</div>
			<div class="cl2"></div>
...
<?php tux_related_posts_cat('video'); ?>
